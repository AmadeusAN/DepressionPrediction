...
class Conv_regression_selfattention(nn.Module):
    def __init__(self, channel):  # (64,7999)
        ...
        self.conv5 = nn.Conv2d(
            channel, 256, kernel_size=(4, 3), stride=(1, 1), padding=(0, 1), bias=False
        )
...
class DCCRN(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(
            2, 16, kernel_size=(9, 3), stride=(3, 1), padding=(1, 1), bias=False
        )
        ...
        self.conv6 = nn.Conv2d(
            256, 256, kernel_size=(6, 3), stride=(1, 1), padding=(0, 1), bias=False
        )
